...
df_train = pd.read_csv('data/Perceptron/trainLinearlySeparable.txt', skiprows = [0], header=None, delimiter = '\s*')
df_test = pd.read_csv('data/Perceptron/testLinearlySeparable.txt', header=None, delimiter = '\s*')

df_train = pd.read_csv('data/Perceptron/trainLinearlyNonSeparable.txt', skiprows = [0], header=None, delimiter = '\s*')
df_test = pd.read_csv('data/Perceptron/testLinearlyNonSeparable.txt', header=None, delimiter = '\s*')

df_train = pd.read_csv('data/kesler/Train.txt', skiprows = [0], header=None, delimiter = '\s*')
df_test = pd.read_csv('data/kesler/Test.txt', header=None, delimiter = '\s*')


binary_train = df_train.values
binary_test = df_test.values 
...
#        print(new_weights)
    ...
    print(test_accuracy(binary_test, weights))
